    ...
    return (
      <div className='body-special-request-1'>
                  ...
                  <div className="input-field">
                      <div className="input">
                        <Grid container spacing={6} justifyContent={'center'} paddingTop={4} paddingBottom={4}>
                            ...
                            <Grid item container md={12} justifyContent='center'>
                            <FormControl fullWidth sx={{display:'flex',justifyContent:'center'}}> 
                                    <InputLabel id="clients">Productos</InputLabel>               
                                    <Select
                                        label="Productos"
                                        name="products"
                                        id="products"
                                        ...
                                        onChange={handleInputChange}
                                        sx={{width: '100%' }} 
                                        error={errors.products !== '' && errors.products !== undefined ? true : false}
                                        >
                                            {
        ...
        <div className='container-result-special-request-1'>
            <h1 class="titulo">Clientes que tienen el producto en común</h1>
            <table class="tabla">
              <thead class="thead">
                <tr>
                  <th>Nombre</th>
